...
CLAUDE.md記載の既知課題への対応と、デバッグで判明した物理知見:
  ...
  300K基準のNEdT 1Kが屋根上では約2〜4K（屋根中央値の典型Tb 273〜276Kで2.5〜2.7K。
  266Kで3.8倍/272Kで2.9倍/280Kで2.1倍、帯域3.4-4.2µm）の輝度温度ノイズに増幅される。
...
r["tank_v2_note"] = (
    ...
    "物理知見: 低ε屋根(見かけ266-280K)ではPlanck非線形によりNEdT1K@300Kが約2〜4K"
    "(屋根中央値の典型で2.5-2.7K)に増幅され、単発検知は原理的にSNR<1(ep1のAUC0.5-0.65はこの物理限界)。"
