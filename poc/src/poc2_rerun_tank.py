...
exec(open('/home/claude/poc/src/poc2_scene_sim.py').read().split('results = {}')[0])
...
r = json.load(open('/home/claude/poc/out/poc2_results.json'))
...
json.dump(r, open('/home/claude/poc/out/poc2_results.json', 'w'), ensure_ascii=False, indent=1)
print("updated")
