...
URLS = [
    ("soumu2_洪水対策_ダム事前放流", "https://www.soumu.go.jp/main_content/001031992.pdf"),
    ("soumu2_盛土等による災害の防止", "https://www.soumu.go.jp/main_content/001019214.pdf"),
    ("soumu2_倒木事前伐採調査", "https://www.soumu.go.jp/main_content/000952036.pdf"),
    ("soumu2_太陽光発電設備等の導入", "https://www.soumu.go.jp/main_content/000888406.pdf"),
    ("soumu2_浄化槽行政", "https://www.soumu.go.jp/main_content/000852499.pdf"),
    ("soumu2_河川の陸閘の管理運用", "https://www.soumu.go.jp/main_content/000789443.pdf"),
    ("soumu2_災害時の道路啓開", "https://www.soumu.go.jp/main_content/000769012.pdf"),
    ("soumu2_農道林道の維持管理", "https://www.soumu.go.jp/main_content/000610656.pdf"),
    ("soumu2_土砂災害対策_森林の管理", "https://www.soumu.go.jp/main_content/000387806.pdf"),
    ("maff2_ため池点検検証結果", "https://www.maff.go.jp/j/nousin/bousai/bousai_saigai/b_tameike/attach/pdf/tameike_iinkai-59.pdf"),
    ("maff2_ため池法概要", "https://www.maff.go.jp/j/nousin/bousai/bousai_saigai/b_tameike/attach/pdf/hozenhou-1.pdf"),
    ("jstage_廃止ため池の現状", "https://www.jstage.jst.go.jp/article/jjsidre/87/11/87_935/_article/-char/ja/"),
    ("jstage_ため池水草繁茂域衛星", "https://www.jstage.jst.go.jp/article/jshwr/36/0/36_300/_article/-char/ja/"),
    ("jstage_ため池事前放流貯留容量", "https://www.jstage.jst.go.jp/result/global/-char/ja?globalSearchKey=" + urllib.parse.quote("ため池 事前放流 貯留容量")),
    ("cinii_四国_ため池_Sentinel", "https://cir.nii.ac.jp/opensearch/all?q=" + urllib.parse.quote("ため池データベース Sentinel") + "&format=json&count=30"),
    ("cinii_陸閘", "https://cir.nii.ac.jp/opensearch/all?q=" + urllib.parse.quote("陸閘 管理") + "&format=json&count=30"),
    ("cinii_利水ダム_事前放流_衛星", "https://cir.nii.ac.jp/opensearch/all?q=" + urllib.parse.quote("利水ダム 事前放流") + "&format=json&count=50"),
]
