...
URLS = [
    ...
    # === G. 第2バッチ（案1の出口・先行研究、案2の先行研究） ===
    ("hkd_十勝岳火山噴火緊急減災対策砂防計画_検討報告書",
     "https://www.hkd.mlit.go.jp/as/tisui/ho928l00000004oj-att/fvme8k0000001jd5.pdf"),
    ("kamifurano_十勝岳火山避難計画R6改定",
     "https://www.town.kamifurano.hokkaido.jp/contents/01soumu/0110soumu/bosai/hinankankoku/tokatidakekazanhinankeikaku-2024.06.pdf"),
    ("thr_蔵王計画概要",
     "https://www.thr.mlit.go.jp/shinjyou/03_sabou/kazan-funka/zao/02_zao_keikakugaiyou.pdf"),
    ("miyagi_蔵王山噴火シナリオと被害想定",
     "https://www.pref.miyagi.jp/soshiki/sabomizusi/zaosan.html"),
    ("jsece_融雪型火山泥流の発生要因と移動特性",
     "https://www.jsece.or.jp/event/conf/abstract/2021/pdf/160.pdf"),
    ("jstage_泥流発生過程を考慮した融雪型火山泥流の予測",
     "https://www.jstage.jst.go.jp/article/jscejhe/70/4/70_159/_pdf"),
    ("stc_融雪型火山泥流_流木対策と被害想定",
     "https://www.stc.or.jp/journal_sabo/pdf/art_133/133_04_Tech-note01.pdf"),
    ("kazan_次世代火山_研究課題一覧",
     "https://www.kazan-pj.jp/research"),
    ("kazan_次世代火山_2025成果報告",
     "https://www.kazan-pj.jp/reporting/research2025"),
    ("eps_草津白根2018_融雪泥流_危機時ハザード評価",
     "https://link.springer.com/article/10.1186/s40623-021-01522-0"),
    ("eps_草津白根2018_pdf",
     "https://earth-planets-space.springeropen.com/counter/pdf/10.1186/s40623-021-01522-0.pdf"),
    # 案2の先行研究（融雪→地すべり／土壌雨量指数）
    ("jstage_融雪を考慮した土壌水分量_土砂災害危険度",
     "https://www.jstage.jst.go.jp/article/jjshwr/30/2/30_89/_pdf"),
    ("jstage_解析融雪量と実効雨量_融雪災害警戒指標",
     "https://www.jstage.jst.go.jp/article/jscejge/77/3/77_195/_pdf"),
    ("rtri_融雪災害の危険度判定システム",
     "https://www.rtri.or.jp/rd/division/rd46/rd4610/rd46100113.html"),
    ("jasdim_融雪量推定手法",
     "https://www.jasdim.or.jp/gijutsu/jisuberi_joho/kaiseki/yuseturyo/model.html"),
    ("pwri_極端化する雪氷災害_防災減災技術の開発R4_R9",
     "https://thesis.pwri.go.jp/files/123023988566fa3393748a2.pdf"),
    ("jstage_積雪期の第三紀層地すべりの運動特性",
     "https://www.jstage.jst.go.jp/article/jls2003/41/1/41_1_37/_pdf"),
]
