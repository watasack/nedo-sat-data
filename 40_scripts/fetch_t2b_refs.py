...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "t2b_refs")
...
def main():
    ...
    with open(os.path.join(here, "refs_urls.txt"), encoding="utf-8") as f:
